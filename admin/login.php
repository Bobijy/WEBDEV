...
?>
<div
    style="width: 100vw; height: 100vh; display: flex; align-items: center; justify-content: center; background: #0A0A0A;">
    <div
        style="background: #171717; padding: 40px; border: 1px solid #2E2E2E; border-radius: 8px; width: 100%; max-width: 400px; text-align: center;">
        <h2 style="font-family: var(--font-heading); color: var(--accent); margin-bottom: 20px;">Admin Login</h2>
        <form id="adminLoginForm">
            <div id="loginMsg"
                style="display:none; margin-bottom:15px; font-size:0.85rem; padding:10px; border-radius:4px;"></div>
            ...
            <div class="form-group" style="text-align: left; position: relative;">
                ...
                <button type="button" id="togglePassword"
                    style="position:absolute; right:10px; top:32px; background:none; border:none; color:#8A8A8A; cursor:pointer;">Show</button>
            </div>
